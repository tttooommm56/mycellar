...
public class VocalActivity extends TabActivity {
				...
				switch(menuId) {
					...
					case MENU_RETIRER_ACTION :
						...
						if (vinDao.retire1Bouteille(idVin, currentStock) > 0) {
							loadTabList(currentTab);
							Toast.makeText(getApplicationContext(), "Le stock a �t� mis � jour.", Toast.LENGTH_LONG).show();
						} else {
							Toast.makeText(getApplicationContext(), "Le stock n'a pas pu �tre mis � jour.", Toast.LENGTH_LONG).show();
						}					
						break;
					...
					case MENU_SUPPRIMER_ACTION :
						AlertDialog.Builder builder = new AlertDialog.Builder(VocalActivity.this);
			    		...
			    		.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
			    			public void onClick(DialogInterface dialog, int id) {
			    				...
			    				vinDao.delete(idVin);
			    				loadTabList(currentTab);
			    				Toast.makeText(getApplicationContext(), "L'item a �t� supprim�.", Toast.LENGTH_LONG).show();
			    			}
			    		})
